...
import edu.ap.spring.security.WebSecurityConfig;
...
public class MainController {
	...
	@PostMapping(value="/user")
  	public String newUser(@RequestParam String username, @RequestParam String password) {
		...
		String encryptedPwd = wsConfig.passwordEncoder().encode(password);
		WebUser newUser = new WebUser(username, encryptedPwd);
		repo.save(newUser);
		wsConfig.addUser(newUser);
