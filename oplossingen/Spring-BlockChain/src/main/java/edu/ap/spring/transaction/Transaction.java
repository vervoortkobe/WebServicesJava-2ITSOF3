...
public class Transaction implements Serializable {
	...
	public String toJSON() {
		...
		try {
			blockObj.put("transactionId", this.transactionId);
			blockObj.put("sender", this.getSender());
			blockObj.put("recipient", this.getRecipient());
			blockObj.put("value", this.getValue());
		} 
